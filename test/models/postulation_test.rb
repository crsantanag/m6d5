...
class PostulationTest < ActiveSupport::TestCase
  fixtures :all, except: :offers # Esto omite los datos de offers.yml y solo usa los datos creados en setup
  ...
  test "should create a postulation and notify owner" do
